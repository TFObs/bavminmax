...
If result = 0 Then
 ...
 .TextMatrix(.Row, 4) & "UT     Azimut: " & .TextMatrix(.Row, 6) & Chr(176) & ", Höhe: " & .TextMatrix(.Row, 7) & Chr(176)
End With
frmPlanetarium.show
Else
...
MsgBox "Es ist ein Fehler beim Erstellen des Charts aufgetreten" & vbCrLf & _
     "Überprüfen Sie Ihre Internetverbindung und ggf. versuchen Sie es " & vbCrLf & _
     "zu einem späteren Zeitpunkt noch einmal..", vbCritical, "Fehler beim Erstellen"
                ...
                If Sunter < Uhrzeit And Uhrzeit <= 24 Or Sauf > Uhrzeit And Uhrzeit >= 0 Then
                    ...
                    If aktHoehe > 0 Then 'Filter der Höhe über Horizont
                       ...
                       With rsergebnis
                        ...
                        'If Len(rstAbfrage.Fields("Kürzel")) > 10 Then
                            'SternName = rstAbfrage.Fields("Kürzel")
                        'Else
                            SternName = rstAbfrage.Fields("Kürzel") & " " & rstAbfrage.Fields("Stbld")
                        'End If
...
Public Sub gridfüllen(Optional sSQL)
