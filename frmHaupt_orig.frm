...
Begin VB.Form frmHaupt 
   ...
   Begin TabDlg.SSTab VTabs 
      ...
      Begin VB.Frame frmOrt 
         ...
         Begin VB.CommandButton cmdOrtOK 
            Height          =   495
            Left            =   4320
            Picture         =   "frmHaupt_orig.frx":091E
            Style           =   1  'Grafisch
            TabIndex        =   16
            Top             =   3960
            Width           =   495
   ...
   Begin VB.CommandButton cmdListe 
      ...
      Height          =   615
      Left            =   1080
      Picture         =   "frmHaupt_orig.frx":0C28
      Style           =   1  'Grafisch
      TabIndex        =   10
   ...
   Begin VB.CommandButton cmdInternet 
      Height          =   495
      Left            =   5400
      Picture         =   "frmHaupt_orig.frx":0F32
      Style           =   1  'Grafisch
      TabIndex        =   9
      ToolTipText     =   "Internet-Recherche"
      Top             =   720
   ...
   Begin VB.CommandButton cmdÖffnen 
      Height          =   495
      Left            =   3360
      Picture         =   "frmHaupt_orig.frx":123C
      Style           =   1  'Grafisch
      TabIndex        =   8
   ...
   Begin VB.CommandButton cmdGridgross 
      Height          =   495
      Left            =   4680
      Picture         =   "frmHaupt_orig.frx":1546
      Style           =   1  'Grafisch
      TabIndex        =   6
   ...
   Begin VB.CommandButton cmdListdrucken 
      Height          =   495
      Left            =   6120
      Picture         =   "frmHaupt_orig.frx":1E10
      Style           =   1  'Grafisch
      TabIndex        =   5
   ...
   Begin VB.CommandButton cmdErgebnis 
      ...
      Height          =   615
      Left            =   2160
      Picture         =   "frmHaupt_orig.frx":211A
      Style           =   1  'Grafisch
      TabIndex        =   2
   ...
   Begin VB.CommandButton cmdAbfrag 
      ...
      Height          =   615
      Left            =   120
      Picture         =   "frmHaupt_orig.frx":2424
      Style           =   1  'Grafisch
      TabIndex        =   1
   ...
   Begin VB.CommandButton cmdListspeichern 
      ...
      Height          =   495
      Left            =   5400
      Picture         =   "frmHaupt_orig.frx":272E
      Style           =   1  'Grafisch
      TabIndex        =   0
   ...
   Begin VB.Image Image2 
      Height          =   480
      Left            =   3960
      Picture         =   "frmHaupt_orig.frx":2A38
      Top             =   720
      Visible         =   0   'False
      Width           =   480
   End
   Begin VB.Image Image1 
      Height          =   480
      Left            =   3360
      Picture         =   "frmHaupt_orig.frx":2D42
      Top             =   720
      Visible         =   0   'False
      Width           =   480
   End
